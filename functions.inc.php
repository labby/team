<?php
function convert_team_link ($m_link, $hide_email) {

		
	$the_array = explode(" ", trim($m_link));
	...
	if ($hide_email == 1) { 
		...
		$m_link = "<script type=\"text/javascript\">showteammail('".$word_1."');</script>"; 	
	} else {
		if ($linktext == '') {$linktext = $word_1;} 
		$m_link = "<a href=\"mailto:$m_link\">$linktext</a>"; 
	}
	return $m_link;
